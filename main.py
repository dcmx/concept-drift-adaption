...
if __name__ == "__main__":
    ...
    # Drift adaptation  #
    #####################
    parser.add_argument('--drift_adaptation', help='use drift adaptation', action='store_true')
    parser.add_argument('--drift_adaptation_mode', help='type of concept drift adaptation; `original`, `custom`', type=str, default='custom')
    parser.add_argument('--b1', help='adaptation b1', type=float, choices=[Range(0.01, 0.99)], default=0.5)
    parser.add_argument('--b2', help='adaptation b2', type=float, choices=[Range(0.01, 0.99)], default=0.5)
    parser.add_argument('--b3', help='adaptation b3', type=float, choices=[Range(0.01, 0.99)], default=0.5)
    ...
    parser.add_argument('--drift_mode', help='type of concept drift; `soft`, `hard`, `sudden`', type=str, default='soft')
